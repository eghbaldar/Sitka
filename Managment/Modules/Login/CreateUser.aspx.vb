...
Partial Class Managment_Modules_Login_CreateUser
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Title = "ایجاد کاربر جدید برای ورود به سیستم مدیریتی"
    End Sub
    ...
    Protected Sub CU_CreatedUser(ByVal sender As Object, ByVal e As System.EventArgs) Handles CU.CreatedUser
        ...
        '---
        BLL.InsertProfileUser(CU.UserName, fn, ln, Email_1, Nothing)
        ...
        If FileUpload.FileName <> String.Empty Then
            If ValidationFilePath(FileUpload.FileName) Then
                If FileUpload.PostedFile.ContentLength < 70000 Then
                    StrPath = MapPath("~\Managment\Modules\Login\Images\User\") + CU.UserName + Mid(FileUpload.FileName, FileUpload.FileName.Length - 3, 4)
                    Session("PathPicture") = "~\Managment\Modules\Login\Images\User\" + CU.UserName + Mid(FileUpload.FileName, FileUpload.FileName.Length - 3, 4)
    ...
    Protected Sub CU_NextButtonClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.WizardNavigationEventArgs) Handles CU.NextButtonClick
        ...
        If e.CurrentStepIndex = 1 Then
            ...
            Else
                CType(CU.CompleteStep.ContentTemplateContainer.FindControl("Im"), Image).ImageUrl = "~\Managment\Modules\Login\images\user\User_Default.JPG"
                '---
                Dim BLL As New MyMembership
                BLL.UpdateImage("~\Managment\Modules\Login\images\user\User_Default.JPG", CU.UserName)
                '---
            End If
    ...
    Protected Sub btn_HaveRoles_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Response.Redirect("~\Managment\Modules\Login\roles.aspx")
    End Sub


    Protected Sub btnDone_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Response.Redirect("~\Managment\")
    End Sub
End Class
